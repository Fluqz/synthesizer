...
export class MembraneSynth extends Instrument {
    ...
    constructor(options:any = {}) {
        ...
        this.wave = options.pitchDecay != undefined ? options.pitchDecay : this.synth.get().oscillator.type
        this.octaves = options.octaves != undefined ? options.octaves : this.synth.get().octaves
        this.pitchDecay = options.pitchDecay != undefined ? options.pitchDecay : this.synth.get().pitchDecay
