...
// gl_FragColor = vec4(vec3(concentricCircles(st, vec2(0.0,0.0), 4.0, 2.0),concentricCircles(st, vec2(0.0,0.0), 3.0, 3.0),concentricCircles(st, vec2(0.0,0.0), 3.0, 3.0)),1.0) - vec4(0.4, 0.4, 0.4, 0.4);